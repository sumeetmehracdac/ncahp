...
export const professionCategories: ProfessionCategory[] = [
  {
    ...
    professions: [
      ...
      { id: "p2", name: "Biochemist (nonclinical)", icon: FlaskConical, color: "hsl(200, 75%, 45%)" },
      { id: "p3", name: "Cell Geneticist", icon: Atom, color: "hsl(320, 65%, 50%)" },
      { id: "p4", name: "Microbiologist (nonclinical)", icon: Bacteria, color: "hsl(160, 70%, 45%)" },
      { id: "p5", name: "Molecular Biologist (nonclinical)", icon: Microscope, color: "hsl(210, 70%, 50%)" },
      { id: "p6", name: "Molecular Geneticist", icon: DnaOff, color: "hsl(300, 65%, 52%)" },
      { id: "p7", name: "Cytotechnologist", icon: ScanSearch, color: "hsl(250, 70%, 55%)" },
      { id: "p8", name: "Forensic Science Technologist", icon: Fingerprint, color: "hsl(10, 75%, 50%)" },
      { id: "p9", name: "Histotechnologist", icon: Microscope, color: "hsl(340, 70%, 55%)" },
      { id: "p10", name: "Hemato Technologist", icon: Droplets, color: "hsl(0, 75%, 50%)" },
      { id: "p11", name: "Medical Lab Technologist", icon: TestTube2, color: "hsl(190, 70%, 45%)" },
    ],
  },
  {
    id: "cat2",
  ...
  },
  {
    ...
    professions: [{ id: "p22", name: "Physiotherapist", icon: Activity, color: "hsl(142, 70%, 40%)" }],
  },
  {
    id: "cat4",
  ...
  },
  {
    ...
    professions: [{ id: "p28", name: "Occupational Therapist", icon: Hand, color: "hsl(35, 80%, 50%)" }],
  },
  {
    id: "cat7",
