...
import { Search, Building, MapPin, AlertCircle, Shield, Info } from 'lucide-react';
...
export function CommitteeSelectionStep({ 
  ...
  const isStateFiltered = !currentUserContext.canAssignToAllStates;
  const userStateName = currentUserContext.stakeholder.state?.stateName;
      ...
      {isStateFiltered && (
        <Alert className="max-w-2xl mx-auto bg-amber-50 border-amber-200">
          ...
          <AlertDescription className="text-amber-800">
            <strong>State-filtered view:</strong> Showing only {userStateName} committees based on your account permissions.
          </AlertDescription>
        </Alert>
      )}
      ...
      {currentUserContext.canAssignToAllStates && (
        <Alert className="max-w-2xl mx-auto bg-blue-50 border-blue-200">
          ...
          <AlertDescription className="text-blue-800">
            <strong>Full access:</strong> As NCAHP HO, you can assign roles to committees in any state.
          </AlertDescription>
        </Alert>
      )}
