              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-3">
                  <Input
                    ...
                    className="h-12 text-lg flex-1 bg-background border-border"
                  ...
                  >
                    ...
                    <div className="flex gap-3">
                      <Input
                        ...
                        className="h-12 text-lg tracking-widest text-center flex-1 bg-background border-border"
                        maxLength={6}
                      ...
                      <Button 
                        ...
                        className={`h-12 px-6 ${emailVerified ? 'bg-accent' : 'bg-primary hover:bg-primary/90'}`}
                      >
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">We'll verify it with an OTP</p>
            </div>
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-sm font-medium">Phone Number</Label>
                <div className="flex gap-3">
                  <div className="flex items-center h-12 px-4 bg-muted rounded-md border border-border text-muted-foreground">
                    +91
                  </div>
                  <Input
                    id="phone"
                  ...
                  >
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button 
                        ...
                        className={`h-12 px-6 ${phoneVerified ? 'bg-accent' : 'bg-primary hover:bg-primary/90'}`}
                      >
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Select your nationality status</p>
            </div>
            <RadioGroup
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">At least 8 characters long</p>
            </div>
