...
const ProposalSubmission = () => {
    ...
    const updateProposalDetails = useCallback(<K extends keyof ProposalDetailsData>(
        field: K,
        value: ProposalDetailsData[K]
    ) => {
        setFormState(prev => ({
            ...prev,
    ...
    const updateBudgetMaster = useCallback(<K extends keyof BudgetMasterData>(
        field: K,
        value: BudgetMasterData[K]
    ) => {
        setFormState(prev => ({
            ...prev,
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-center gap-2 py-3">
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-medium text-sm transition-all ${formState.currentScreen === 'proposal'
                        ...
                        >
                            ...
                            {formState.proposalDetails.totalOutlay && (
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-medium text-sm transition-all ${formState.currentScreen === 'budget'
                                ? 'bg-accent text-white shadow-lg shadow-accent/25'
                                : 'bg-muted text-muted-foreground hover:bg-muted/80'
                                }`}
                        >
