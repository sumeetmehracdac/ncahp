...
const MOCK_COPI_LIST: COPIDetail[] = [
    ...
    { id: '2', name: 'Dr. Priya Sharma', designation: 'Associate Professor', department: 'Neurology', institution: 'AIIMS Delhi' },
    { id: '3', name: 'Dr. Rajesh Verma', designation: 'Professor', department: 'Oncology', institution: 'AIIMS Delhi' },
    { id: '4', name: 'Dr. Sunita Rao', designation: 'Assistant Professor', department: 'Pediatrics', institution: 'AIIMS Delhi' },
    { id: '5', name: 'Dr. Vikram Singh', designation: 'Professor', department: 'Orthopedics', institution: 'AIIMS Delhi' },
    { id: '6', name: 'Dr. Meera Patel', designation: 'Associate Professor', department: 'Psychiatry', institution: 'AIIMS Delhi' },
    { id: '7', name: 'Dr. Amit Gupta', designation: 'Professor', department: 'Radiology', institution: 'AIIMS Delhi' },
    { id: '8', name: 'Dr. Neha Kapoor', designation: 'Assistant Professor', department: 'Dermatology', institution: 'AIIMS Delhi' },
];
...
const ProposalDetailsForm = ({ data, updateData, onContinue }: ProposalDetailsFormProps) => {
    ...
    const toggleCOPI = (copi: COPIDetail) => {
        ...
        if (isSelected) {
            updateData('coPIs', data.coPIs.filter(c => c.id !== copi.id));
        } else {
    ...
    const removeCOPI = (id: string) => {
        updateData('coPIs', data.coPIs.filter(c => c.id !== id));
    };
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    {data.objective.length} / 2000 characters
                                </p>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    {data.deliverables.length} / 2000 characters
                                </p>
                            </div>
                        </div>
                    </div>
