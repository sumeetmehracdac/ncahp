...
const DeclarationStep2B = ({ formData, updateFormData, onSubmit }: Props) => {
  const updateDeclaration = (field: keyof Form2BDeclaration, value: boolean | string) => {
            ...
            {["Yes", "No"].map((opt) => (
              <Label 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg border cursor-pointer transition-all ${
                  (opt === "Yes" && formData.declaration.permitCancellation) || 
          ...
          >
            {["Yes", "No"].map((opt) => (
              <Label 
                key={opt} 
                className={`flex items-center gap-2 px-4 py-2 rounded-lg border cursor-pointer transition-all ${
                  (opt === "Yes" && formData.declaration.legalDispute) || 
