...
const AcademicQualificationStep2B = ({ formData, updateFormData }: Props) => {
  ...
  const updateQualification = (id: string, field: keyof Form2BAcademicQualification, value: string | File | null) => {
    const updated = formData.academicQualifications.map((q) => (q.id === id ? { ...q, [field]: value } : q));
    updateFormData("academicQualifications", updated);
  };
    ...
    <div className="space-y-8">
      <div className="text-center pb-6 border-b border-border">
        ...
        <h2 className="text-2xl md:text-3xl font-display font-semibold text-foreground mb-2">
          Screen-4: Academic Qualification
        </h2>
        <p className="text-muted-foreground max-w-xl mx-auto">
          Enter your academic qualifications in allied and healthcare professions.
        </p>
      </div>
        ...
        {formData.academicQualifications.map((qual, index) => (
          <div key={qual.id} className="p-5 border border-border rounded-xl bg-slate-50 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <Label>
                  Name of Institution/Hospital/Clinic/Laboratory <span className="text-destructive">*</span>
                </Label>
                <Input
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateQualification(qual.id, "courseName", e.target.value)}
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateQualification(qual.id, "modeOfLearning", value)}
                >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateQualification(qual.id, "mediumOfInstruction", e.target.value)}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateQualification(qual.id, "admissionYear", e.target.value)}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateQualification(qual.id, "passingYear", e.target.value)}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) => updateQualification(qual.id, "certificate", e.target.files?.[0] || null)}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    type="file"
                    accept=".pdf,.jpg,.jpeg,.png"
                    onChange={(e) => updateQualification(qual.id, "transcript", e.target.files?.[0] || null)}
                    className="absolute inset-0 opacity-0 cursor-pointer"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div
                    className={`flex items-center gap-3 p-3 rounded-lg border-2 border-dashed transition-all ${qual.syllabus ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"}`}
                  >
                    <Upload className="w-5 h-5 text-muted-foreground" />
                    <span className="text-sm text-foreground font-medium truncate">
                  ...
                  <input
                    type="file"
                    accept=".pdf,.jpg,.jpeg,.png"
                    onChange={(e) => updateQualification(qual.id, "syllabus", e.target.files?.[0] || null)}
                    className="absolute inset-0 opacity-0 cursor-pointer"
                  />
                </div>
              </div>
