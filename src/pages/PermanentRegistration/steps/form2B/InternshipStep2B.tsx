...
const InternshipStep2B = ({ formData, updateFormData }: Props) => {
  ...
  const updateInternship = (id: string, field: keyof Form2BInternship, value: string | File | null) => {
    const updated = formData.internships.map((i) => (i.id === id ? { ...i, [field]: value } : i));
    updateFormData("internships", updated);
  };
              ...
              <div key={intern.id} className="p-5 border border-border rounded-xl space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      value={intern.programName}
                      onChange={(e) => updateInternship(intern.id, "programName", e.target.value)}
                      placeholder="e.g., Clinical Internship"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label>Country</Label>
                    <Input
                      value={intern.country}
                      onChange={(e) => updateInternship(intern.id, "country", e.target.value)}
                      placeholder="Country of internship"
                    />
                  </div>
                  <div className="md:col-span-2 space-y-2">
                    <Label>Name & Address of Organisation</Label>
                    <Input
                      value={intern.organizationNameAddress}
                      onChange={(e) => updateInternship(intern.id, "organizationNameAddress", e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="date"
                      value={intern.completionDate}
                      onChange={(e) => updateInternship(intern.id, "completionDate", e.target.value)}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      value={intern.totalHours}
                      onChange={(e) => updateInternship(intern.id, "totalHours", e.target.value)}
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <Textarea
                      value={intern.coreDuties}
                      onChange={(e) => updateInternship(intern.id, "coreDuties", e.target.value)}
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateInternship(intern.id, "certificate", e.target.files?.[0] || null)}
                    />
                  </div>
                </div>
              </div>
