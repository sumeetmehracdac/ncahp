  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        ...
        className={`relative rounded-2xl border-2 border-dashed p-8 lg:p-12 transition-all duration-300 ${
          isDragging ? 'bg-primary/5 border-primary' : 'bg-muted/30 border-border hover:border-primary/50 hover:bg-muted/50'
        }`}
      >
        <input
          type="file"
              ...
              {files.map((uploadedFile) => {
                ...
                return (
                  <motion.div
                    ...
                    exit={{ opacity: 0, x: -20 }}
                    className="flex items-center gap-3 p-3 rounded-xl bg-card border border-border group hover:border-primary/30 transition-colors"
                  >
                    ...
                    <Button
                      ...
                      className="opacity-0 group-hover:opacity-100 transition-opacity h-8 w-8 p-0 rounded-lg hover:bg-destructive/10 hover:text-destructive"
                    >
                      <X className="h-4 w-4" />
                    </Button>
                  </motion.div>
