...
const AnnouncementFilters = ({
  ...
  const statusFilters = [
    ...
    { key: 'new', label: 'New', icon: Sparkles, count: counts.new },
    { key: 'archived', label: 'Past', icon: Archive, count: counts.archived },
  ];

  const categoryFilters = [
    { key: 'all', label: 'All', icon: null },
    { key: 'head-office', label: 'Head Office', icon: Building2 },
    { key: 'state-council', label: 'State Council', icon: MapPin },
  ];
